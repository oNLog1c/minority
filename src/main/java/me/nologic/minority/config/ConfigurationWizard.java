...
public class ConfigurationWizard {
    ...
    public final void generate(Class<? extends MinorityFeature> feature) {
        ...
        config.options().setHeader(Collections.singletonList("This configuration file was automatically generated by Minority."));
        ...
        // 8. And after all the job is done, we shouldn't forget to save the config file!
        config.save(file);
